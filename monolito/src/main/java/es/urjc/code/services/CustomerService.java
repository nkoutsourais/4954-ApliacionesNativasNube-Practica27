...
import es.urjc.code.services.notifications.CustomerNotificationFeatureToggle;
...
public class CustomerService {
    ...
    @Autowired
    CustomerNotificationFeatureToggle customerNotificationFeatureToggle;
    ...
    public void increaseCredit(Long customerId, Money extra) {
        ...
        this.customerNotificationFeatureToggle.send(message);
    }
